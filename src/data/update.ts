...
import { type CallbackQueryX, installCallbackQueryMethods } from "./callback-query.ts";
import { type ChatJoinRequestX, installChatJoinRequestMethods } from "./chat-join-request.ts";
import { type ChosenInlineResultX, installChosenInlineResultMethods } from "./chosen-inline-result.ts";
import { type InlineQueryX, installInlineQueryMethods } from "./inline-query.ts";
import { installMessageMethods, type MessageX } from "./message.ts";
import { installPreCheckoutQueryMethods, type PreCheckoutQueryX } from "./pre-checkout-query.ts";
import { installShippingQueryMethods, type ShippingQueryX } from "./shipping-query.ts";
